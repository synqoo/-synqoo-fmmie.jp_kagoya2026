...
<head>
    <meta charset="UTF-8">
    <title>いがふるさと会場・応募｜ＪＡ共済 presents 学ぼう防災　親子で作ろう！ ラジオ工作教室</title>
    <meta name="description" content="JAいがふるさと会場のラジオ工作教室。8月22日（土）開催。応募期間5/7（木）～6/12（金）。開催概要と応募フォーム（準備中）をご案内します。" />
...
<div class="jak-container">
    ...
    <header class="jak-title-block">
        ...
        <p class="jak-subtitle">応募ページ（ＪＡいがふるさと会場）</p>
    </header>

    <!-- <div class="jak-preperiod-heading" role="status">
        <p class="jak-preperiod-heading__line">応募期間は5/7(木)～6/12(金)です。</p>
    ...
    <section class="jak-section" aria-labelledby="jak-overview-heading">
        ...
        <dl class="jak-dl">
            <div><dt>会　　場</dt><dd>ＪＡいがふるさと 会場（ＪＡいがふるさと 本店）</dd></div>
            <div><dt>日　　時</dt><dd>8月22日（土）　10：00～12：00　　受付開始　9：30～</dd></div>
            <div><dt>募集人数</dt><dd>小学生のお子様と保護者の方、ペア３０組６０名</dd></div>
            <div><dt>場　　所</dt><dd>ＪＡいがふるさと　本店　3階大会議室（伊賀市平野西町１－１）
                <div class="jak-map-slot jak-map-slot--embed" role="img" aria-label="地図（画像を後日配置）"><iframe class="jak-map-slot__frame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3277.269627906153!2d136.13193921206894!3d34.77398697278072!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6001573502f349ed%3A0x4281f4b65754e995!2z44CSNTE4LTA4MjAg5LiJ6YeN55yM5LyK6LOA5biC5bmz6YeO6KW_55S677yR4oiS77yR!5e0!3m2!1sja!2sjp!4v1774393492692!5m2!1sja!2sjp"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div></dd></div>
                    <div><dt></dt><dd>
                    <a class="jak-btn-download" href="/event/jakyousai/file/radio_iga.pdf" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-download" aria-hidden="true"></i>チラシのダウンロード（PDF）</a></dd></div>
                </dl>
    </section>
    ...
    <section class="jak-section" aria-labelledby="jak-form-heading">
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>参加者募集</h5>
            ...
            <input type="hidden" name="form_id" value="260" />
            <input type="hidden" name="form_title" value="学ぼう防災 いがふるさと会場" />
            </div>
    ...
    <section class="jak-section" aria-labelledby="jak-notes-heading">
        ...
        <ul class="jak-list-notes">
            ...
            <li>当選された方は、６月２２日（月）［予定］までにＦＭ三重よりメールにて結果を通知いたします。また、落選の方は、６月２２日（月）以降にご応募いただいたメールアドレスにご返信させていただきます。</li>
