...
<head>
    <meta charset="UTF-8">
    <title>伊勢会場・応募｜ＪＡ共済 presents 学ぼう防災　親子で作ろう！ ラジオ工作教室</title>
    <meta name="description" content="JA伊勢会場のラジオ工作教室。8月8日（土）開催。応募期間5/7（木）～6/30（火）。開催概要と応募フォーム（準備中）をご案内します。" />
...
<div class="jak-container">
    ...
    <header class="jak-title-block">
        ...
        <p class="jak-subtitle">応募ページ（ＪＡ伊勢 会場）</p>
    </header>
    ...
    <section class="jak-section" aria-labelledby="jak-overview-heading">
        ...
        <dl class="jak-dl">
            <div><dt>会　　場</dt><dd>ＪＡ伊勢 会場</dd></div>
            <div><dt>日　　時</dt><dd>8月8日（土）　10：00～12：00　　受付開始　9：30～</dd></div>
            <div><dt>募集人数</dt><dd>ＪＡ伊勢管内在住の小学１年生〜６年生と保護者の方３０組<br />※１家族につき１キット</dd></div>
            <div><dt>場　　所</dt><dd>ＪＡ伊勢　伊勢中央支店　2階　大会議室（伊勢市御薗町長屋４６２）
                <div class="jak-map-slot jak-map-slot--embed" role="img" aria-label="地図（画像を後日配置）"><iframe class="jak-map-slot__frame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3287.8253836987815!2d136.70573571205975!3d34.50731087287649!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60045aff6c2848db%3A0xc1cd06d8808bc6ef!2z44CSNTE2LTA4MDQg5LiJ6YeN55yM5LyK5Yui5biC5b6h6JaX55S66ZW35bGL77yU77yW77yS!5e0!3m2!1sja!2sjp!4v1774393365026!5m2!1sja!2sjp" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div></dd></div>
                    <div><dt></dt><dd>
                    <a class="jak-btn-download" href="/event/jakyousai/file/radio_ise.pdf" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-download" aria-hidden="true"></i>チラシのダウンロード（PDF）</a></dd></div>        
                </dl>
    </section>

    <section class="jak-section" aria-labelledby="jak-elig-heading">
        <h2 id="jak-elig-heading" class="jak-section-title">応募資格</h2>
        <p>以下の市町にお住いの小学生のお子様と保護者の方</p>
        <ul class="jak-list-muni">
            <li>伊勢市</li>
            <li>鳥羽市</li>
            <li>志摩市</li>
            <li>尾鷲市</li>
    ...
    <section class="jak-section" aria-labelledby="jak-form-heading">
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>参加者募集</h5>
            ...
            <input type="hidden" name="form_id" value="259" />
            <input type="hidden" name="form_title" value="学ぼう防災 伊勢会場" />
            </div>
    ...
    <section class="jak-section" aria-labelledby="jak-notes-heading">
        ...
        <ul class="jak-list-notes">
            ...
            <li>ＪＡ伊勢管内在住の小学１年生～６年生と保護者の方３０組 ※１家族１キット</li>
            <li>応募者多数の場合は抽選となります。</li>
            <li>当選された方は、７月９日（木）［予定］までにＦＭ三重よりメールにて結果を通知いたします。また、落選の方は、７月９日（木）以降にご応募いただいたメールアドレスにご返信させていただきます。</li>
