...
<head>
    <meta charset="UTF-8">
    <title>みえなか会場・応募｜ＪＡ共済 presents 学ぼう防災　親子で作ろう！ ラジオ工作教室</title>
    <meta name="description" content="JAみえなか会場のラジオ工作教室。8月1日（土）開催。応募期間5/7（木）～6/12（金）。開催概要と応募フォーム（準備中）をご案内します。" />
...
<div class="jak-container">
    ...
    <header class="jak-title-block">
        ...
        <p class="jak-subtitle">応募ページ（ＪＡみえなか 会場）</p>
    </header>
    ...
    <section class="jak-section" aria-labelledby="jak-overview-heading">
        ...
        <dl class="jak-dl">
            <div><dt>会　　場</dt><dd>ＪＡみえなか 会場（ＪＡみえなか ふれあいセンター）</dd></div>
            <div><dt>日　　時</dt><dd>8月1日（土）　10：00～12：00　　受付開始　9：30～</dd></div>
            <div><dt>募集人数</dt><dd>小学生のお子様と保護者の方、ペア３０組６０名</dd></div>
            <div><dt>場　　所</dt><dd>ＪＡみえなか　ふれあいセンター（津市一志町日置80）
                <div class="jak-map-slot jak-map-slot--embed" role="img" aria-label="地図（画像を後日配置）">
                    <iframe  class="jak-map-slot__frame"  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3282.825675447936!2d136.43915081206495!3d34.65755917282215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60040de22d61bbfd%3A0xd7c38dc42e85c47!2z44CSNTE1LTI1MDMg5LiJ6YeN55yM5rSl5biC5LiA5b-X55S65pel572u77yY77yQ!5e0!3m2!1sja!2sjp!4v1774393242792!5m2!1sja!2sjp" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div></dd></div>
                 <div><dt></dt><dd>
                        <a class="jak-btn-download" href="/event/jakyousai/file/radio_mienaka.pdf" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-download" aria-hidden="true"></i>チラシのダウンロード（PDF）</a></dd></div> 
        </dl>
    </section>
    ...
    <section class="jak-section" aria-labelledby="jak-form-heading">
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>参加者募集</h5>
            ...
            <input type="hidden" name="form_id" value="258" />
            <input type="hidden" name="form_title" value="学ぼう防災 みえなか会場" />
            </div>
