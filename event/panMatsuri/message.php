...
<html lang="ja" itemscope itemtype="http://schema.org/Blog">
  <head>
    ...
    <title>レディオキューブパン祭り　自薦他薦情報｜レディオキューブFM三重</title>
...
<article class="entry-card stack card-color container stack-lg" role="main">
    <h2 class="entry-title" itemprop="name">レディオキューブパン祭り パン屋さん情報を送る</h2>
<?php echo $error['top'] ?>
<!-- formzstrap-->
<div class="stack stack-md"  <?php if($submitmode==1){echo 'style="display:none;"';}?>>
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>推薦するパン屋さん</h5>
            <div class="form-field">
                <label class="form-field__label">推薦<span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="x_fld1">店舗名（読み方）<span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="r_message">推しのパンやおすすめコメント <span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="x_fld2">お店の住所やSNSやホームページなど</label>
            ...
            <hr />
            <div class="form-field">
                <label class="form-field__label" for="u_name">投稿者のお名前<span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="u_email">投稿者のメールアドレス<span class="vad">必須</span></label>
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>自薦の場合はお店の連絡先も入力してください</h5>
            <div class="form-field">
            ...
            <div class="form-field">
                <label class="form-field__label" for="x_fld3">営業時間や定休日</label>
            ...
            <p>店舗やパンの写真など</p>
            <div class="form-field">
                <label class="form-field__label">ファイルを選択してください</label>
            ...
            <input type="hidden" name="form_title" value="パン屋さん集まれ！" />
            </div>
