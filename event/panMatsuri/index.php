...
<article class="pm-event card card-radius-lg card-shadow-sm">
    <div class="pm-event__body">
        ...
        <p class="pm-event__place">場所：三重大学　三翠ホール</p>
        <p class="pm-event__note">※パン祭り参加整理券の配布はございません。</p>
        ...
        <div class="pm-event__detail" id="pm-event-detail-1" hidden>
            <div class="pm-event__detail-title">5月30日（土）出店者一覧</div>
            <div class="pm-cards">
                <div class="pm-card">
                ...
                <div class="pm-card">
                    <p class="pm-card__name">ミーベのパン工房</p>
