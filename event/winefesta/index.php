...
<div class="wf-container">
        ...
        <div class="wf-hero__body">
            ...
            <dl class="wf-hero__meta">
                <div class="wf-hero__meta-item">
                    ...
                    <dd>2026年10月17日<span class="wf-day">（土）</span>・18日<span class="wf-day">（日）</span></dd>
                </div>
                <div class="wf-hero__meta-item">
                    <dt><i class="fa-solid fa-location-dot" aria-hidden="true"></i> 会場</dt>
                    <dd>近鉄四日市駅前商店街 アーケード内公園通り</dd>
                </div>
            </dl>
            <p class="wf-hero__cta">
                <a href="#ticket" class="wf-btn wf-btn--primary"><i class="fa-solid fa-ticket" aria-hidden="true"></i> チケットの購入はこちら</a>
            </p>
        </div>
    </header>
    ...
    <section class="wf-section">
        ...
        <table class="wf-overview">
            <tbody>
                ...
                <tr><th>協　賛</th><td>日本トランスシティ㈱ 三十三銀行 住友電装㈱ ㈱リョーケン ㈱フォレスト・オオモリ ㈱i-kyo 三重日野自動車㈱ ㈱エイワ ㈱角屋 ㈱サノプランニング ㈲ダイトー地所 ㈱トワ</td></tr>
            </tbody>
        </table>
    </section>
    ...
    <!-- ========== ご利用案内 ========== -->
    <section class="wf-section">
        <h2 class="wf-heading">ご利用案内</h2>
        <h3 class="wf-subheading"><i class="fa-solid fa-wine-glass-empty" aria-hidden="true"></i> ワインを楽しむには</h3>
    ...
    <section class="wf-section">
        ...
        <div class="wf-shops">
            <article class="wf-shop card card-radius-lg card-shadow-sm">
                <div class="wf-shop__photo wf-photo"><img src="images/shop-kito.jpg" alt="葡萄酒亭きとう" /></div>
                <div class="wf-shop__body">
                    <h3 class="wf-shop__name">葡萄酒亭きとう</h3>
                    <p class="wf-shop__desc">店内は高級鮨店のような総檜づくりのワインバー。高級ワインも楽しめます。</p>
                    <p class="wf-shop__addr"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> 四日市市諏訪栄町8-8 ブラウンビル1F</p>
                    <p class="wf-shop__tel"><i class="fa-solid fa-phone" aria-hidden="true"></i> 059-350-8023</p>
                    <p class="wf-shop__holiday">定休日 日曜・祝日</p>
                </div>
            </article>
            ...
            <article class="wf-shop card card-radius-lg card-shadow-sm">
                <div class="wf-shop__photo wf-photo"><img src="images/shop-eri.jpg" alt="ワインと菓子1 eriプルミエリ" /></div>
                <div class="wf-shop__body">
                    <h3 class="wf-shop__name">ワインと菓子1 eriプルミエリ</h3>
                    <p class="wf-shop__desc">ワインと菓子を楽しんでもらえる7席の小さなワインバー。</p>
                    <p class="wf-shop__addr"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> 四日市市西新地8-1 ダイヤモンドビル2階</p>
                    <p class="wf-shop__tel"><i class="fa-solid fa-phone" aria-hidden="true"></i> 070-6588-1380</p>
                    <p class="wf-shop__holiday">定休日 日曜</p>
                </div>
            </article>
    ...
    <!-- ========== フードを楽しむには ========== -->
    <section class="wf-section">
        <h2 class="wf-heading">フードを楽しむには</h2>
        <p class="wf-lead">四日市を代表するフレンチ・イタリアン・中華・創作料理の人気店の美食の数々をお楽しみください。</p>
        ...
        <div class="wf-shops">
            ...
            <article class="wf-shop card card-radius-lg card-shadow-sm">
                <div class="wf-shop__photo wf-photo"><img src="images/food-kotetsu.jpg" alt="虎鉄" /></div>
                <div class="wf-shop__body">
            ...
            <article class="wf-shop card card-radius-lg card-shadow-sm">
                <div class="wf-shop__photo wf-photo"><img src="images/food-monte.jpg" alt="TAVERNETTA MONTE" /></div>
                <div class="wf-shop__body">
                    <h3 class="wf-shop__name">TAVERNETTA MONTE</h3>
                    <p class="wf-shop__desc">ちいさなイタリア食堂。イタリア料理と自然派ワインが楽しめる。</p>
                    <p class="wf-shop__addr"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> 四日市市諏訪栄町22-6 1F</p>
                    <p class="wf-shop__tel"><i class="fa-solid fa-phone" aria-hidden="true"></i> 059-340-8708</p>
                    <p class="wf-shop__holiday">定休日 火曜・第2・4月曜</p>
                </div>
            </article>

            <article class="wf-shop card card-radius-lg card-shadow-sm">
                <div class="wf-shop__photo wf-photo"><img src="images/food-bosque.jpg" alt="スペインバルボスケ" /></div>
                <div class="wf-shop__body">
                    <h3 class="wf-shop__name">スペインバルボスケ</h3>
                    <p class="wf-shop__desc">本格スパニッシュとワインを楽しむお洒落なバル。一押しは最高級の生ハムベジョータ。</p>
                    <p class="wf-shop__addr"><i class="fa-solid fa-location-dot" aria-hidden="true"></i> 四日市市安島1-1-42</p>
                    <p class="wf-shop__tel"><i class="fa-solid fa-phone" aria-hidden="true"></i> 059-340-4140</p>
                    <p class="wf-shop__holiday">定休日 月曜</p>
                </div>
            </article>
    ...
    <section class="wf-section">
        ...
        <dl class="wf-faq">
            ...
            <div class="wf-faq__item">
                <dt><span class="wf-faq__mark wf-faq__mark--q">Q</span>未成年者の入場は可能でしょうか？</dt>
                <dd><span class="wf-faq__mark wf-faq__mark--a">A</span>入場可能です。ソフトドリンクやフードをお楽しみください。</dd>
            </div>
            <div class="wf-faq__item">
                <dt><span class="wf-faq__mark wf-faq__mark--q">Q</span>フード店舗のみの利用はできますか？</dt>
                <dd><span class="wf-faq__mark wf-faq__mark--a">A</span>できます。好きなお店のフードをお楽しみください。</dd>
            </div>
            <div class="wf-faq__item">
            ...
            <div class="wf-faq__item">
                <dt><span class="wf-faq__mark wf-faq__mark--q">Q</span>持ち込みは可能でしょうか？</dt>
            ...
            <div class="wf-faq__item">
                ...
                <dd><span class="wf-faq__mark wf-faq__mark--a">A</span>チケットの払い戻しには対応しておりません。ご了承ください。</dd>
            </div>
        </dl>
    </section>
    ...
    <section class="wf-section">
        ...
        <p class="wf-access">
            <i class="fa-solid fa-train-subway" aria-hidden="true"></i> 近鉄四日市駅より徒歩2分<br>
            <strong>公園通り商店街</strong>
        </p>
    </section>

    <!-- ========== 四日市JAZZ FESTIVAL ========== -->
    <section class="wf-section wf-jazz">
        <div class="wf-jazz__body">
    ...
    <!-- ========== 主催・後援・協賛 ========== -->
    <section class="wf-section wf-credits">
        <div class="wf-credit">
            <p class="wf-credit__label">主催</p>
            <div class="wf-credit__logos wf-photo"><img src="images/logo-fmmie.png" alt="レディオキューブFM三重" /></div>
        </div>
        <div class="wf-credit">
            <p class="wf-credit__label">後援</p>
            <div class="wf-credit__logos">
                <span class="wf-photo wf-photo--logo"><img src="images/logo-city.png" alt="四日市市" /></span>
                <span class="wf-photo wf-photo--logo"><img src="images/logo-cci.png" alt="四日市商工会議所" /></span>
                <span class="wf-photo wf-photo--logo"><img src="images/logo-kanko.png" alt="四日市観光協会" /></span>
                <span class="wf-photo wf-photo--logo"><img src="images/logo-chunichi.png" alt="中日新聞社" /></span>
                <span class="wf-photo wf-photo--logo"><img src="images/logo-jazz.png" alt="四日市JAZZ FESTIVAL" /></span>
            </div>
        </div>
        <div class="wf-credit">
