  ...
  <script type="text/babel">
    ...
    const ColorThemes = () => {
      ...
      const themes = [
        {
          name: "モダンブルー",
          description: "清潔感と信頼性を表現するビジネス向けテーマ",
          primary: {
            main: "#2563EB",
            light: "#60A5FA",
            dark: "#1E40AF"
        ...
        {
          name: "エレガントパープル",
          description: "高級感と創造性を演出するクリエイティブ向けテーマ",
          primary: {
            main: "#7C3AED",
            light: "#A78BFA",
            dark: "#5B21B6"
        ...
        {
          name: "ナチュラルグリーン",
          description: "自然と調和するエコ・健康系サービス向けテーマ",
          primary: {
            main: "#059669",
            light: "#34D399",
            dark: "#047857"
        ...
        {
          name: "ダイナミックオレンジ",
          description: "活気と情熱を伝えるエネルギッシュなテーマ",
          primary: {
            main: "#EA580C",
            light: "#FB923C",
            dark: "#C2410C"
        ...
        {
          name: "ミニマルダーク",
          description: "洗練されたダークモード対応の先進的テーマ",
          primary: {
            main: "#3B82F6",
            light: "#60A5FA",
            dark: "#1D4ED8"
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Webデザイン用の配色パターン - 5テーマ</p>
            </div>
