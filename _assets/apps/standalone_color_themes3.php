  ...
  <script type="text/babel">
    ...
    const ColorThemes = () => {
      ...
      const themes = [
        {
          name: "ソフトコーラル",
          description: "優しく女性的な印象の美容・ファッション向けテーマ",
          primary: {
            main: "#F472B6",
            light: "#FBCFE8",
            dark: "#DB2777"
        ...
        {
          name: "fmmie",
          description: "本サイト（index.php）で使用中のカラーチャート／レディオキューブFM三重",
          primary: {
            main: "#00d0b0",
            light: "#88fbff",
            dark: "#3C8591"
        ...
        {
          name: "fmmie（サブテーマ）",
          description: "本サイト用カラーチャートの修正版／Secondaryの明度順序・アクセシビリティ・色温度の統一",
          primary: {
            main: "#00b89a",
            light: "#5CE6D0",
            dark: "#008C7A"
        ...
        {
          name: "オーシャンブリーズ",
          description: "涼しげで透明感のあるトラベル・リゾート向けテーマ",
          primary: {
            main: "#0284C7",
            light: "#38BDF8",
            dark: "#075985"
        ...
        {
          name: "ヴィンテージローズ",
          description: "レトロで落ち着いたカフェ・アンティーク向けテーマ",
          primary: {
            main: "#BE185D",
            light: "#F472B6",
            dark: "#9F1239"
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">新しい配色パターン - 5テーマ</p>
            </div>
