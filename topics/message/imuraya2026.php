...
<html lang="ja" itemscope itemtype="http://schema.org/Blog">
  <head>
    ...
    <title>ザ・スーパーマリオギャラクシー・ムービー　オリジナルグッズ 応募- 特番・イベント - レディオキューブFM三重</title>
...
<article class="entry-card stack card-color container stack-lg" role="main">
    <h2 class="entry-title" itemprop="name">ザ・スーパーマリオギャラクシー・ムービー　オリジナルグッズ 応募</h2>
<?php echo $error['top'] ?>
<!-- formzstrap-->
    ...
    <div class="stack stack-md"  <?php if($submitmode==1){echo 'style="display:none;"';}?>>
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>参加者申込（4名様まで）</h5>
            <div class="form-field">
                <label class="form-field__label" for="u_name">代表者氏名<span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="u_kana">代表者フリガナ<span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="x_sel">ご本人を含めた合計参加人数<span class="vad">必須</span></label>
                <select id="x_sel" name="x_sel" required="required">
                    <option <?php if($_POST['x_sel'] == 0){echo 'selected="selected"';} ?> value="0">1</option>
                    <option <?php if($_POST['x_sel'] == 1){echo 'selected="selected"';} ?> value="1">2</option>
                    <option <?php if($_POST['x_sel'] == 2){echo 'selected="selected"';} ?> value="2">3</option>
                    <option <?php if($_POST['x_sel'] == 3){echo 'selected="selected"';} ?> value="3">4</option>
                </select>
            ...
            <hr />
            <div class="form-field">
                <label class="form-field__label" for="p_name1">同伴者氏名１</label>
                <input id="p_name1" name="p_name1" type="text" value="<?php echo $_POST['p_name1'] ?>"  />
                <?php if (!empty($error['p_name1'])): ?>
                    <p class="form-field__error"><?php echo $error['p_name1'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
                <label class="form-field__label" for="p_name2">同伴者氏名２</label>
                <input id="p_name2" name="p_name2" type="text" value="<?php echo $_POST['p_name2'] ?>"  />
                <?php if (!empty($error['p_name2'])): ?>
                    <p class="form-field__error"><?php echo $error['p_name2'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
                <label class="form-field__label" for="p_name3">同伴者氏名３</label>
                <input id="p_name3" name="p_name3" type="text" value="<?php echo $_POST['p_name3'] ?>"  />
                <?php if (!empty($error['p_name3'])): ?>
                    <p class="form-field__error"><?php echo $error['p_name3'] ?></p>
                <?php endif; ?>
            </div>
            <hr />
            <div class="form-field">
                <label class="form-field__label">車いすスペース利用希望</label>
            ...
            <div class="form-field">
                <label class="form-field__label">隣接する席</label>
                <div class="cluster cluster-gap-md">
                    <label class="cluster cluster-gap-xs">
                        <input type="radio" name="p_sex1" value="0" <?php if($_POST['p_sex1']==0){echo 'checked="checked"';}?>  />
                        <span>希望無し</span>
                    </label>
                    <label class="cluster cluster-gap-xs">
                        <input type="radio" name="p_sex1" value="1" <?php if($_POST['p_sex1']==1){echo 'checked="checked"';}?>  />
                        <span>希望する</span>
                    </label>
                </div>
                <?php if (!empty($error['p_sex1'])): ?>
                    <p class="form-field__error"><?php echo $error['p_sex1'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
                <label class="form-field__label" for="x_fld1">台数（車椅子）</label>
            ...
            <div class="form-field" id="privacy-consent-field">
                ...
                <?php if (!empty($error['privacy_consentx'])): ?>
                    <p class="form-field__error"><?php echo $error['privacy_consentx'] ?></p>
                <?php endif; ?></p>
            </div>
            ...
            <input type="hidden" name="form_title" value="国際音楽交歓コンサート2026" />
            </div>
