...
<html lang="ja" itemscope itemtype="http://schema.org/Blog">
  <head>
    ...
    <title>ミュージカル『20年後のあなたに会いたくて』応募- 特番・イベント - レディオキューブFM三重</title>
...
<article class="entry-card stack card-color container stack-lg" role="main">
    <h2 class="entry-title" itemprop="name">ミュージカル『20年後のあなたに会いたくて』応募</h2>
<?php echo $error['top'] ?>
<!-- formzstrap-->
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>応募者情報</h5>
            ...
            <div class="form-field">
                <label class="form-field__label">性別<span class="vad">必須</span></label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="x_fld1">身長<span class="vad">必須</span></label>
            ...
            <hr />
            <div class="form-field">
                <label class="form-field__label" for="x_fld2">演劇・ミュージカル・コンサート・ドラマ等　出演歴（あれば）</label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="r_message">自己PR（300字以内）</label>
            ...
            <div class="form-field">
                <label class="form-field__label" for="x_fld3">自身の最低音域と、最高音域</label>
                <input id="x_fld3" name="x_fld3" type="text" value="<?php echo $_POST['x_fld3'] ?>"  />
                <?php if (!empty($error['x_fld3'])): ?>
                    <p class="form-field__error"><?php echo $error['x_fld3'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
                <label class="form-field__label">志望配役</label>
                <div class="cluster cluster-gap-md">
                    <label class="cluster cluster-gap-xs">
            ...
            <hr />
            <div class="form-field">
                <label class="form-field__label">写真１（バストアップ）</label>
                <input type="file" name="r_attached" value="1" />
            </div>
            <div class="form-field">
                <label class="form-field__label" for="r_attached2">写真２（全身）</label>
<input type="file" name="r_attached2" value="1" />
            </div>
            <div class="form-field">
                <label class="form-field__label" for="x_fld4">課題台本演技動画URL</label>
                <input id="x_fld4" name="x_fld4" type="text" value="<?php echo $_POST['x_fld4'] ?>"  />
                <?php if (!empty($error['x_fld4'])): ?>
                    <p class="form-field__error"><?php echo $error['x_fld4'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
                <label class="form-field__label" for="x_fld5">課題曲歌唱動画URL</label>
                <input id="x_fld5" name="x_fld5" type="text" value="<?php echo $_POST['x_fld5'] ?>"  />
                <?php if (!empty($error['x_fld5'])): ?>
                    <p class="form-field__error"><?php echo $error['x_fld5'] ?></p>
                <?php endif; ?>
            </div>
            <?php if ($enable_optional_fields_toggle): ?>
            ...
            <input type="hidden" name="form_title" value="ミュージカル 20年後のあなたに会いたくて" />
            </div>
