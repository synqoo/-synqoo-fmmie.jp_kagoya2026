...
<div class="form-field">
            ...
            <div class="form-field">
                ...
                <div class="cluster cluster-gap-xs">
                    <input id="p_age1" name="p_age1" type="number" class="input-narrow" value="<?php echo $_POST['p_age1'] ?>" /><span>歳</span>
                </div>
            ...
            <div class="form-field">
                ...
                <input id="p_con1" name="p_con1" type="text" value="<?php echo $_POST['p_con1'] ?>"  />
            ...
            <div class="form-field">
                ...
                <select id="x_sel" name="x_sel" >
<option value="0">--選択してください--</option>
                    <option <?php if($_POST['x_sel'] == 1){echo 'selected="selected"';} ?> value="1">家族・パートナー</option>
                    <option <?php if($_POST['x_sel'] == 2){echo 'selected="selected"';} ?> value="2">ご友人</option>
                    <option <?php if($_POST['x_sel'] == 3){echo 'selected="selected"';} ?> value="3">その他</option>
                </select>
                <?php if (!empty($error['x_sel'])): ?>
                    <p class="form-field__error"><?php echo $error['x_sel'] ?></p>
                <?php endif; ?>
            ...
            <hr />
            <div class="form-field">
                <label class="form-field__label" for="x_fld2">どこでこのイベントをお知りになりましたか？<span class="vad">必須</span></label>
