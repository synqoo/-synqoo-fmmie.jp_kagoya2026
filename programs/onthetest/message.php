...
<html lang="ja" itemscope itemtype="http://schema.org/Blog">
  <head>
    <meta charset="UTF-8">
    <meta name="description" content="テスト用のテンプレートす">
    <title>メッセージ - OnTheTest - レディオキューブFM三重</title>
    <link rel="canonical" href="https://fmmie.jp/programs/onthetest/">
    <?php require_once(INCLUDE_HTMLHEAD_PATH); ?>
    <!--Include module="HTMLヘッダー -->
<!-- Open Graph Protocol -->
    <meta property="og:type" content="article">
    <meta property="og:locale" content="ja_JP">
    <meta property="og:title" content="OnTheTest">
    <meta property="og:url" content="https://fmmie.jp/programs/onthetest/">
    <meta property="og:description" content="テスト用のテンプレートす">
    <meta property="og:site_name" content="OnTheTest">
    <meta property="og:image" content="/mt7/mt-static/support/theme_static/theme-from-synqoo2026/img/siteicon-sample.png">
    <!-- Microdata -->
    <meta itemprop="description" content="テスト用のテンプレートす">
    <meta itemprop="name" content="OnTheTest">

   <link rel="stylesheet" href="/_assets/css/mt-core.css<?php echo $themeParam; ?>" />
   <link rel="stylesheet" href="https://fmmie.jp/programs/onthetest/styles.css<?php echo $themeParam; ?>" />
...
<main class="section">
      <div class="index-container stack">
        <section class="stack">
            <?php require_once("/home/kir691871/public_html/fmmie.jp/programs/onthetest/headbanner.php"); ?>
...
<!-- formzstrap-->
    ...
    <div class="stack stack-md"  <?php if($submitmode==1){echo 'style="display:none;"';}?>>
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>メッセージ</h5>
            ...
            <div class="form-field">
                <label class="form-field__label" for="r_songtitle">リクエスト曲</label>
                <input id="r_songtitle" name="r_songtitle" type="text" value="<?php echo $_POST['r_songtitle'] ?>"  />
                <?php if (!empty($error['r_songtitle'])): ?>
                    <p class="form-field__error"><?php echo $error['r_songtitle'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
                <label class="form-field__label" for="r_artist">アーティスト名</label>
                <input id="r_artist" name="r_artist" type="text" value="<?php echo $_POST['r_artist'] ?>"  />
                <?php if (!empty($error['r_artist'])): ?>
                    <p class="form-field__error"><?php echo $error['r_artist'] ?></p>
                <?php endif; ?>
            </div>
            <div class="form-field">
            ...
            <div class="form-field">
                <label class="form-field__label">今の気分</label>
                <div class="cluster cluster-gap-md">
                    ...
                    <label class="cluster cluster-gap-xs">
                        <input type="radio" name="p_sex1" value="2" <?php if($_POST['p_sex1']==2){echo 'checked="checked"';}?>  />
                        <span>普通</span>
                    </label>
                    <label class="cluster cluster-gap-xs">
                        <input type="radio" name="p_sex1" value="3" <?php if($_POST['p_sex1']==3){echo 'checked="checked"';}?>  />
                        <span>ほっといて</span>
                    </label>
                </div>
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>よろしければお書き添えください</h5>
            ...
            <input type="hidden" name="form_title" value="FORMZ TEST3" />
            </div>
