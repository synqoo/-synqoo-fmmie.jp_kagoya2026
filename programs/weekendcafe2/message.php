...
$phppath = '/home/kir691871/public_html/fmmie.jp/';
?>
...
<html lang="ja" itemscope itemtype="http://schema.org/Blog">
  <head>
    ...
    <title>メッセージ - 安藤大作・エデュケーションラジオ - レディオキューブFM三重</title>
    <link rel="canonical" href="https://fmmie.jp/programs/andojuku/">
    <?php require_once(INCLUDE_HTMLHEAD_PATH); ?>
    <!--Include module="HTMLヘッダー -->
<!-- Open Graph Protocol -->
    <meta property="og:type" content="article">
    <meta property="og:locale" content="ja_JP">
    <meta property="og:title" content="安藤大作・エデュケーションラジオ">
    <meta property="og:url" content="https://fmmie.jp/programs/andojuku/">
    
    <meta property="og:site_name" content="安藤大作・エデュケーションラジオ">
    <meta property="og:image" content="/mt7/mt-static/support/theme_static/theme-from-programblog2calam/img/siteicon-sample.png">
    <!-- Microdata -->
...
<main class="section">
      <div class="index-container stack">
        <section class="stack">
            <?php require_once("/home/kir691871/public_html/fmmie.jp/programs/andojuku/headbanner.php"); ?>
    ...
    <div class="stack stack-md"  <?php if($submitmode==1){echo 'style="display:none;"';}?>>
        ...
        <h5 class="optional-fields-heading"><i class="fa fa-pencil" aria-hidden="true"></i>よろしければお書き添えください</h5>
            ...
            <div class="form-field" id="privacy-consent-field">
                <p>▶ 当サイト内で入力された個人情報は、本件の対応のためにのみ利用します。詳しくはプライバシーポリシーをご覧ください。<br />
